...
async function run() {
    const testUsernames = [];
    for (let i = 2; i <= 16; i++) testUsernames.push(`@test${i}`);
    ...
    console.log('🔍 Fetching all upcoming 1min Paid Tournaments...');
    ...
    console.log('\n✨ Done! You can now join any of these tournaments as the 16th player.');
}
